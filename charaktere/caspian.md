...
> Regelwerk: **D&D 2024 (5.5e)**. Spieler: Björn. Technische Begriffe **Englisch**.

## Kopf
- **Name:** Caspian „Cas" · **Species:** Human · **Class & Level:** **Bard 3 · College of Lore**
- **Background:** Wayfarer · **Alignment:** Chaotic Good · **Proficiency Bonus:** +2
...
## Combat
- **AC:** 13 · **Initiative:** +3 *(inkl. Jack of All Trades)* · **Speed:** 30 ft
- **Hit Points:** **21 / 21** *(Stufe 3: +6)* · **Temp HP:** — · **Hit Dice:** 3×d8 · **Passive Perception:** 14 · **Death Saves:** ☐☐☐/☐☐☐

## Skills
**Proficient (+2 PB):**
- **Stealth** +4 *(DEX)* · **Insight** +2 *(WIS)* · **Perception +4** *(WIS)* ⭐EXP · **Performance +7** *(CHA)* ⭐EXP · **Persuasion** +5 *(CHA)* · **Sleight of Hand** +4 *(DEX)*
- **Deception** +5 *(CHA — Lore)* · **Investigation** +2 *(INT — Lore)* · **Animal Handling** +2 *(WIS — Lore)*

> **Jack of All Trades:** +1 auf alle Ability Checks **ohne** Proficiency (auch Initiative).

## College of Lore (Stufe 3)
- **Bonus Proficiencies:** Deception, Investigation, Animal Handling (oben eingerechnet).
- **Cutting Words** *(Reaction, kostet 1 Bardic Inspiration):* ein sichtbarer Gegner in 60 ft, der eine Damage Roll macht oder einen Attack/Check/Save **gelingt** — du ziehst deinen Bardic-d6 von seinem Wurf ab (Treffer → Miss, Erfolg → Fehlschlag, oder weniger Schaden). **Handhabung „Variante A"** s. `regeln/REGELWERK-2024.md` (Hausregeln).

## Proficiencies & Languages
- Light Armor · Simple Weapons · Thieves' Tools · 3 Musical Instruments · Sprachen: Common, **Draconic**, **Gnomish**

## Weapons
| Weapon | Attack | Damage | Properties |
|---|---|---|---|
| Dagger | +4 | 1d4+2 piercing | Finesse, Light, Thrown (20/60) |
| Light Crossbow | +4 | 1d8+2 piercing | Ammunition, Loading, Two-Handed, 80/320 |

> Distanz-Liebling: **Starry Wisp** (Spell Attack **+6** mit Klarlicht, 1d8 radiant).

## Feats
- **Lucky** *(Wayfarer)* · **Magic Initiate (Wizard)** *(Human „Versatile")*
...
> *Suggestion* (2nd): ein Ziel in 30 ft, WIS Save vs DC 14, folgt sonst einem vernünftig klingenden Vorschlag (Concentration, bis 8 Std.).
...
### Gefährte ⚔️ Doral
Wachhauptmann (Tank), Neffe **Jory** gerettet. `charaktere/doral.md`.
...
## Persönlichkeit
- **Wesenszug:** staunende Augen, redet mit Gegenständen. **Ideal:** „Jedes Ding & jeder Mensch trägt eine Geschichte." **Bindung:** Aldebran & die Spieluhr. **Makel:** unheilbar neugierig.
- *Beobachtung: unter Druck kühler/härter; Realist (lässt Besiegte nicht laufen).* 

## Hintergrund (Kurz)
Wuchs im Kuriositätenwagen des Sammlers **Aldebran** auf; dieser verschwand, die Erinnerungen verblassen. Die Spieluhr führte ihn nach Aschenfurt, zu Klarlicht — und nun weiß er: **Aldebran ist in der Tiefe, vom Kult benutzt.** *(Plot: nur DM.)*

## Level-Up Log
- **L1** (06-16) erstellt. **S1** Aschenfurt; Pellam; Marisha; 0 HP überlebt.
